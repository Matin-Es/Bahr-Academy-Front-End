    ...
    return (
      <React.Fragment>
        ...
        <div className="btn-group-vertical btgg"  role="group" aria-label="Vertical button group">
          <MDBBtn color="" type="button " className="btn btnmenus mb-4 my_cour"><Link to="/Dashboard/Mycourses">دوره های من</Link></MDBBtn>
          <MDBBtn color="" type="button" className="btn btnmenus mb-4 singup"><Link to="/Courses">ثبت نام دوره ها</Link></MDBBtn>
          <MDBBtn color="" type="button" className="btn btnmenus mb-4 edit "><Link to="/dashboard">ویرایش پروفایل</Link></MDBBtn>
