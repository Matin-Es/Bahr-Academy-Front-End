                    ...
                    <div className={det["holderdet"]}>
                        ...
                        <div className={det["priceholder"]}>
                            <div className={'${det.itholder} ${det.det}'}>
                                ...
                                <div className={'${det.it2} ${small}'}><span className={det["count"]}>5</span> ساعت</div>
                            </div>
                            <div className={'${det.itholder} ${det}'}>
                                <div className={'${det.it1} ${small}'}>تاریخ انتشار : </div>
                                <div className={'${det.it2} ${small}'}><span className={det["count"]}>5</span> مهر <span className={det["count"]}>1398</span></div>
                            </div>
                            <div className={'${det.itholder} ${det.det}'}>
                            ...
                            <div className={'${det.itholder} ${det.det}'}>
                                ...
                                <div className={'${det.it2} ${small}'}><span className={det["count"]}>1345</span> بار</div>
                            </div>
                        </div>
                    </div>
                </div>
